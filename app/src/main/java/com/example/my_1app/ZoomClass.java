...
public class ZoomClass extends AppCompatActivity {
    ...
    public void initializeSdk(Context context) {
        ...
        params.appKey = "WdoLrVwyWZvAb08lY1jdlsEMH33YJnP0OqI3"; // TODO: Retrieve your SDK key and enter it here
        params.appSecret = "gg410j68wVnhNth8RFKhKXYxlpQ1V9XunyFi"; // TODO: Retrieve your SDK secret and enter it here
    ...
    public void joinMeeting(Context context, String meetingNumber, String password) {
        ...
        params.displayName = "Mathesh"; // TODO: Enter your name
    ...
    private void createJoinMeetingDialog() {
        new AlertDialog.Builder(this).setView(R.layout.dialog_main).setPositiveButton("Join", new DialogInterface.OnClickListener() {@Override
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (numberInput != null && numberInput.getText() != null && passwordInput != null && passwordInput.getText() != null) {
                ...
                if (meetingNumber.trim().length() > 0 && password.trim().length() > 0) {
                    joinMeeting(ZoomClass.this, meetingNumber, password);
                }
            }
            dialog.dismiss();
        }
